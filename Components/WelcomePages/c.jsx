      ...
      <div className="mt-10 text-center">
        <div className="mb-6">
          ...
          >
            <path
              fillRule="evenodd"
              d="M3 10a7 7 0 1114 0A7 7 0 013 10zm7-6a6 6 0 100 12 6 6 0 000-12z"
              clipRule="evenodd"
            />
          </svg>
        </div>
        <p className="text-lg font-medium text-gray-600">You haven’t added any favourite restaurants</p>
      </div>
